          ...
          <div class="col-md-12">
              ...
              <div class="card">
                  ...
                  <div class="card-block">
                      <div class="card-body">
                          <form class="needs-validation was-validated" novalidate action="{{route('product.store')}}" method="post">
                            @csrf
                                ...
                                <div class="container">
                                    <div class="row">
                                      ...
                                      <div class="col">
                                        ...
                                        <input name = "stuck"  type="number" class="form-control position-relative" id="stuck" placeholder="Stuck ex:12" value="{{old('stuck')}}" required>
                                      </div>

                                      <div class="col">
                                        <label for="price" >Price</label>
                                        <div class="input-group">
                                        <input name = "price" step="any"  type="number" class="form-control position-relative" id="price" placeholder="price ex:12" value="{{old('price')}}" required>
                                      ...
                                      <div class="col">
                                        ...
                                        <div class="input-group">
                                        <input name = "discount" step="any"  type="number" min="0" max="100" class="form-control position-relative" id="discount" placeholder="Discount ex:10%" value="{{old('discount')}}" required>
                                        <div class="input-group-prepend">
                                      ...
                                      <div class="col ">
                                        ...
                                        <div class="input-group">
                                        <input name = "offer_price" step="any"  type="number" class="form-control position-relative" id="offer_price" placeholder="offer_price ex:12" value="{{old('offer_price')}}" disabled>
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="validationTooltipUsernamePrepend">JD</span>
                                          </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col d-none" id="child_cat_div">
                                            ...
                                            <fieldset class="form-group position-relative">
                                              <select name = "child_cat_id" class="form-control input-xl " id="child_cat_id">
                                              </select>
                                           </fieldset>
                                        </div>
                                        <div class="col">
                                            ...
                                            <fieldset class="form-group position-relative">
                                              <select name = "size" class="form-control input-xl" id="size">
                                                  ...
                                                  <option value="L" {{old('size')=='L' ? 'selected' : ''}}>Larg</option>
                                              </select>
                                           </fieldset>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col">
                                    ...
                                    <fieldset class="form-group position-relative">
                                      <select name = "is_featured" class="form-control -xl" id="xLargeSelect">
                                          ...
                                          <option value="0" {{old('is_featured')=='0' ? 'selected' : ''}}>Featured</option>
                                          <option value="1" {{old('is_featured')=='1' ? 'selected' : ''}}>NotFeatured</option>
                                      </select>
                                   </fieldset>
                                  </div>
                                  <div class="col">
                                    ...
                                    <fieldset class="form-group position-relative">
                                      <select name = "is_recommended" class="form-control -xl" id="xLargeSelect">
                                          ...
                                          <option value="0" {{old('is_recommended')=='0' ? 'selected' : ''}}>Recommended</option>
                                          <option value="1" {{old('is_recommended')=='1' ? 'selected' : ''}}>Not Recommended</option>
                                      </select>
                                   </fieldset>
                                  </div>
